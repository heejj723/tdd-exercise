...
public class MoreSpicyTest {
  ...
  /**
   * 1. 가장 안매운 음식을 올바르게 고르는가
   * 2. 두번째로 안 매운 음식을 올바르게 고르는가
   * 3. 두 개를 섞을 때 올바른 연산을 하는가
   * 4. 섞기 전과 섞은 후에 count 지수가 +1 되는가
   * 5. 모든 스코빌 지수를 K로 만들 수 없는 경우 return -1 을 하는가
   * - 남은 음식이 1개 인 경우 scoville of food >= K 인가?
   * 6. 모든 스코빌 지수가 K 이상인가?
   * - 가장 작은 스코빌 지수가 K 이상인가?
   * */
